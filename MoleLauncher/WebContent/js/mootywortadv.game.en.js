...
undum.game.situations = {
								...
								if(action) {
									...
									if (!Libifels.isItemInInventory(character.mole, "pulsating_fuzz")) {
										...
										if(!story.subtractFromCharacterQuality("health", character.mole.stats.maxHP * 0.1)) {
											...
											undum.game.itemManager.addItem(story.charactersDict.mole, new Items.PulsatingFuzz());                     
										} 
									} else {
										story.writeParagraph("The fuzz already in your pack is vibrating in a worrisome manner; you don't need more of the stuff.");
									}
									story.jumpToNewContent();
								}
							} catch(err) {
		...
		"basement1_fuzzy_caterpillar_you_ok": new undum.SimpleSituation(
				"",
				{
					...
					canView(character, system, hostSituation) {
						return !undum.game.storyViewController.eventFlags.caterpillar_concern_mana_pot_got
					},
		...
		"basement1_ochre_ooze_daughter_slaughter": new undum.SimpleSituation(
				"",
				{
					enter: function(character, system, from) {
						const story = undum.game.storyViewController;
		...
		"basement2_grue_hub": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						if (story.eventDict.mole_major_destiny === undefined) {
							...
							} else if (story.eventDict.mole_major_destiny === "cozy friend") {
								...
								system.doLink("basement2_hub");
							} else if (story.eventDict.mole_major_destiny === "king of the deep") {
								if (story.eventDict.mole_minor_destiny === undefined) {
								...
								} else if (story.eventDict.mole_minor_destiny === "tyrant") {
									...
									// send the mole back to molerat hub
									system.doLink("basement2_hub");
								} else if (story.eventDict.mole_minor_destiny === "groovy") {
									...
									// send the mole back to molerat hub
									system.doLink("basement2_hub");
								} else if (story.eventDict.mole_minor_destiny === "paladin") {
									...
									// send the mole back to molerat hub
									system.doLink("basement2_hub");
								} else if (story.eventDict.mole_minor_destiny === "knight") {
							...
							} /* end of king major destiny */ else if (story.eventDict.mole_major_destiny === "eldritch delver") {
								...
								if (story.eventDict.mole_minor_destiny === "shadowscaper") {
									...
									// send the mole back to molerat hub
									system.doLink("basement2_hub");
								} else if (story.eventDict.mole_minor_destiny === "enlightener") {
									...
									// send the mole back to molerat hub
									system.doLink("basement2_hub");
								} else if (story.eventDict.mole_minor_destiny === "tingler") {
		...
		"basement2_grue_convo_darkness_reward": new undum.SimpleSituation(
				"<p>Like a thorned vine twisting about its host with agonizing languidness to meet sunlight with savagery, a smile all of teeth tears a meandering line of brightness across the creature's abyssal face. \"You are beginning to understand.  Know that there are some here who would put themselves above the darkness, a deluded few who would dare to profess that it is born of them and not the other way 'round.  They will name themselves gods -- beware of such charlatans.\"</p>",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_major_destiny = "king of the deep";
		...
		"basement2_grue_convo_true_warmth": new undum.SimpleSituation(
				"<p>A deep humming vibrates the very marrow in your bones as the creature contemplates your answer.  \"Intriguing.  A bit saccharine for my taste, but appropriately loyal to the twisted depths.\"</p>",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_major_destiny = "cozy friend";
						system.doLink("basement2_grue_hub");
					},
		...
		"basement2_grue_convo_grow_secrets": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						story.eventDict.mole_major_destiny = "eldritch delver";
		...
		"basement2_grue_convo_grow_secrets_elaboration_on_usage_shadowscape": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "shadowscaper";
						system.doLink("basement2_grue_hub");
					},
		...
		"basement2_grue_convo_grow_secrets_elaboration_on_usage_illuminate": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "enlightener";
						system.doLink("basement2_grue_hub");
					},
		...
		"basement2_grue_convo_grow_secrets_elaboration_on_usage_tingly": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "tingler";
						system.doLink("basement2_grue_hub");
					},
		...
		"basement2_grue_convo_crown_ruthless": new undum.SimpleSituation(
				"",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "tyrant";
						system.doLink("basement2_grue_hub");
					},
		...
		"basement2_grue_convo_crown_groovy": new undum.SimpleSituation(
				"<p></p>",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "groovy";
						system.doLink("basement2_grue_hub");
					},
					optionText: function (character, system, situation) {
		...
		"basement2_grue_convo_crown_servant": new undum.SimpleSituation(
				...
				{
					enter: function (character, system, from) {
						// mod character to reflect the moleson's desire to serve a strong leader of lovey darkness
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "knight";
						system.doLink("basement2_grue_hub");
					},
					optionText: function (character, system, situation) {
		...
		"basement2_grue_convo_crown_paladin": new undum.SimpleSituation(
				"<p></p>",
				{
					enter: function (character, system, from) {
						...
						const story = undum.game.storyViewController;
						story.eventDict.mole_minor_destiny = "paladin";
						system.doLink("basement2_grue_hub");
					},
					optionText: function (character, system, situation) {
		...
		dark_mantle_molerat_clarity: new undum.SimpleSituation(
				"",
				{
					enter: function(character, system, from) {
						...
						story.addToCharacterQuality("moleWhole", 6);
						system.doLink("basement2_hub");
					},
		...
		dark_mantle_caterpillar_entombed_flight_observation: new undum.SimpleSituation(
				"",
				{
					enter: function(character, system, from) {
						...
						story.subtractFromCharacterQuality("moleWhole", 5.5);
						system.doLink("basement1_fuzzy_caterpillar_hub");
					},
